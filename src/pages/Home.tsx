        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Modern healthcare management platform connecting patients with doctors seamlessly.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/register" className="hover:text-teal-400 transition-colors">Join as Doctor</Link></li>
              <li><span className="hover:text-teal-400 transition-colors cursor-pointer">Doctor Portal</span></li>
              <li><span className="hover:text-teal-400 transition-colors cursor-pointer">Schedule Management</span></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li>Entity Framework Core 10</li>
              <li>SQL Server</li>
            </ul>
          </div>
        </div>
